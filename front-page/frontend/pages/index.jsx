import {Button, Container, Flex, Heading, Stack, Tooltip} from "@chakra-ui/react";
    ...
    <Container centerContent paddingTop={["0.5in", "1.5in"]}>
      ...
      <Flex>
        <Stack spacing={4} direction="row" align="center">
          <Tooltip hasArrow shouldWrapChildren label="Available soon!" placement="top">
            <Button rightIcon={<ArrowForwardIcon/>} colorScheme="teal" size="lg">Image Repository</Button>
          </Tooltip>
          <Tooltip hasArrow shouldWrapChildren label="Available soon!" placement="top">
            <Button rightIcon={<ArrowForwardIcon/>} colorScheme="teal" size="lg">The Shoppies</Button>
          </Tooltip>
        </Stack>
      </Flex>
    </Container>
